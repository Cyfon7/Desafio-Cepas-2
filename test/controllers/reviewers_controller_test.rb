...
class ReviewersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reviewer" do
    assert_difference('Reviewer.count') do
      post reviewers_url, params: { reviewer: { age: @reviewer.age, name: @reviewer.name, nationality: @reviewer.nationality } }
    end
  ...
  test "should update reviewer" do
    patch reviewer_url(@reviewer), params: { reviewer: { age: @reviewer.age, name: @reviewer.name, nationality: @reviewer.nationality } }
